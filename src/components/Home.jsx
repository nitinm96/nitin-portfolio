      ...
      <MediaQuery minWidth={700}>
        ...
        <div className="relative flex items-center justify-center w-full h-screen top-6">
          ...
          <div className="m-8 mb-44 w-2/4">
            <div className="text-4xl mb-4">Hello, my name is</div>

            <div className=" text-7xl mr-px ">
              <div className="text-[#0478FF]">
                nitin
                <span className="text-[#6EB0FE]"> minhas</span>.
              </div>
            </div>

            <div className="mt-10">{HomeMsg}</div>
            ...
            <div className="flex items-center justify-start w-full space-x-5">
              ...
              >
                <SiGithub />
                <div className="px-3 text-md bold">Github</div>
              </Button>
              <Button
                variant="outlined"
              ...
              >
                <SiLinkedin />
                <div className="px-3 text-md bold">Linkedin</div>
              </Button>
            </div>
          </div>
        </div>
      ...
      <MediaQuery maxWidth={700}>
        ...
        >
          ...
          <div className="flex items-center justify-center text-center m-5">
            Ready to turn theory into practice, transform challenges into
            opportunities, and embark on a journey of continuous learning in the
            tech world.
          </div>
          ...
          <div className="flex items-center justify-center w-full mb-36 space-x-5">
            ...
            >
              <SiGithub />
              <div className="px-3 text-sm">Github</div>
            </Button>
            <Button
              variant="outlined"
              href="https://www.linkedin.com/in/nitin-minhas/"
            ...
            >
              <SiLinkedin />
              <div className="px-3 text-sm">Linkedin</div>
            </Button>
          </div>
        </div>
      </MediaQuery>
